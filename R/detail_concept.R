          ...
          htmltools::tags$tr(
            ...
            htmltools::tags$td(
              ...
              if (!is.na(result$concept_rf_code) && !is.na(result$concept_rf_label)) {
                ...
                result$concept_rf_label %|||% "Unspecified"
              }
            )
          ),
          htmltools::tags$tr(
      ...
      if (!is.na(result[[description_field]])) {
        htmltools::tags$div(
          ...
          htmltools::tags$div(
            ...
            htmltools::HTML(sanitize_description_html(result[[description_field]] %|||% "No description available"))
          )
        )
      }
    )
    ...
    htmltools::tags$div(
      htmltools::tags$b({
        if (!is.na(result$py_code) && !is.na(result$party_label)) {
          ...
          result$party_label %|||% "Unspecified party"
        }
      }),
      htmltools::tags$span(
